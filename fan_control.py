...
# Настройки
FAN_PIN = 14  # GPIO для вентилятора (PWM)
TACH_PIN = 23  # GPIO для тахометра
...
TEMP_MEDIUM = 70  # Температура, до которой вентилятор использует MAX_FAN_SPEED_BELOW
MAX_FAN_SPEED_BELOW = 50  # Макс. скорость вентилятора до TEMP_MEDIUM (%)
COOLDOWN_TIME = 10  # Время работы на 100% после TEMP_HIGH
BLOW_TIME = 3  # Время продувки при запуске
PRE_BLOW_PAUSE = 2  # Ожидание перед продувкой
